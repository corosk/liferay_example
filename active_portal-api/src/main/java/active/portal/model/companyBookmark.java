 ...
 * @see active.portal.model.impl.companyBookmarkImpl
 * @see active.portal.model.impl.companyBookmarkModelImpl
 * @generated
 */
@ImplementationClassName("active.portal.model.impl.companyBookmarkImpl")
@ProviderType
public interface companyBookmark extends companyBookmarkModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link active.portal.model.impl.companyBookmarkImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
