...
public class companyBookmarkWrapper implements companyBookmark,
	...
	@Override
	public active.portal.model.companyBookmark toEscapedModel() {
		return new companyBookmarkWrapper(_companyBookmark.toEscapedModel());
	}

	@Override
	public active.portal.model.companyBookmark toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<active.portal.model.companyBookmark> toCacheModel() {
		return _companyBookmark.toCacheModel();
	}

	@Override
	public int compareTo(active.portal.model.companyBookmark companyBookmark) {
