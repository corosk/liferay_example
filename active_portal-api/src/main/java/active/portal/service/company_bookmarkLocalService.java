...
/**
 * Provides the local service interface for company_bookmark. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see company_bookmarkLocalServiceUtil
...
public interface company_bookmarkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link company_bookmarkLocalServiceUtil} to access the company_bookmark local service. Add custom service methods to {@link active.portal.service.impl.company_bookmarkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public company_bookmark createcompany_bookmark(java.lang.String bookmark_id);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public company_bookmark deletecompany_bookmark(java.lang.String bookmark_id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public company_bookmark fetchcompany_bookmark(java.lang.String bookmark_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public company_bookmark getcompany_bookmark(java.lang.String bookmark_id)
		throws PortalException;
