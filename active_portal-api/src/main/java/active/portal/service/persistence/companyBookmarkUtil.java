 ...
 * @see active.portal.service.persistence.impl.companyBookmarkPersistenceImpl
 * @generated
 */
@ProviderType
public class companyBookmarkUtil {
	...
	*/
	public static List<companyBookmark> findBybookmarkId(
		java.lang.String bookmarkId, int start, int end) {
	...
	*/
	public static List<companyBookmark> findBybookmarkId(
		...
		OrderByComparator<companyBookmark> orderByComparator) {
		return getPersistence()
				   .findBybookmarkId(bookmarkId, start, end, orderByComparator);
	}
	...
	*/
	public static companyBookmark findBybookmarkId_First(
		java.lang.String bookmarkId,
		OrderByComparator<companyBookmark> orderByComparator)
		throws active.portal.exception.NoSuchcompanyBookmarkException {
		return getPersistence()
				   .findBybookmarkId_First(bookmarkId, orderByComparator);
	}
	...
	*/
	public static companyBookmark fetchBybookmarkId_First(
		...
		OrderByComparator<companyBookmark> orderByComparator) {
		return getPersistence()
				   .fetchBybookmarkId_First(bookmarkId, orderByComparator);
	}
	...
	*/
	public static companyBookmark findBybookmarkId_Last(
		...
		throws active.portal.exception.NoSuchcompanyBookmarkException {
		return getPersistence()
				   .findBybookmarkId_Last(bookmarkId, orderByComparator);
	}
	...
	*/
	public static companyBookmark fetchBybookmarkId_Last(
		...
		OrderByComparator<companyBookmark> orderByComparator) {
		return getPersistence()
				   .fetchBybookmarkId_Last(bookmarkId, orderByComparator);
	}
